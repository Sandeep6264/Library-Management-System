...
public class DeleteLibrarian extends javax.swing.JFrame {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
       if(txtId.getText().trim().isEmpty()){
        ...
        try {
            boolean result=AdminDAO.deleteAdmin( Integer.parseInt( txtId.getText()));
            if(result)
            {
                ...
                JOptionPane.showMessageDialog(null,"Record Deleted Unsuccessfully");
        } 
...
//    try{
//        ArrayList<Integer>al=AdminDAO.loadAllId();
//        if(al.isEmpty()){
//            JOptionPane.showConfirmDialog(null,"Librarian not present");
